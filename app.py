...
.apk-link:hover { transform: translateY(-2px); box-shadow: 0 6px 30px rgba(34,197,94,0.4); }
.logs {
  background: var(--bg);
  border: 1px solid var(--border);
  border-radius: 12px;
...
<div class="container">
    ...
    <div class="card-body">
      <div class="row">
        <div>
          ...
          <input type="text" id="appName" value="MyApp" placeholder="MyApp">
        </div>
        <div>
          <label>Package name</label>
          <input type="text" id="packageName" value="com.example.myapp" placeholder="com.example.myapp">
        </div>
      </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="templates">
        <button class="template-btn" onclick="loadTemplate('hello')">👋 Hello World</button>
        ...
        <button class="template-btn" onclick="loadTemplate('input')">⌨️ Ввод текста</button>
      </div>
      <textarea id="javaCode" spellcheck="false" placeholder="// Вставь свой Java код здесь...">package com.example.myapp;
...
<footer>
  ⚡ Java → APK Compiler 2026 • Render Free
</footer>
